...
var _form$elements = _slicedToArray(form.elements, 2),
    title = _form$elements[0],
    author = _form$elements[1];

var _document$querySelect = document.querySelectorAll('.list-item'),
    _document$querySelect2 = _slicedToArray(_document$querySelect, 3),
    navList = _document$querySelect2[0],
    navAdd = _document$querySelect2[1],
    navContact = _document$querySelect2[2];

var allBooks = document.querySelector('.all-books');
var addBook = document.querySelector('.add-book');
var contact = document.querySelector('.contact');
var divTime = document.querySelector('.date-time');
setInterval(function () {
  var dt = _luxon.DateTime.now();

  divTime.textContent = dt.toLocaleString(_luxon.DateTime.DATETIME_FULL_WITH_SECONDS);
}, 1000);
var inputBook = {};
...
populateFields();
},{"luxon":"node_modules/luxon/build/cjs-browser/luxon.js","./modules/index.js":"modules/index.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
